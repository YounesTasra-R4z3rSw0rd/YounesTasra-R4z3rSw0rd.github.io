---
layout: post
title: TryHackMe | Team Write-Up   
date: 2023-03-09 12:00:00 -500
categories: [TryHackMe, Easy]
tags: [ctf, nmap, ffuf, gobuster, vhost, Web Exploitation,  LFI, Automation, Python3, BurpSuite, Intruder, Bruteforcing, Information Disclosure, SSH Private Key, Command Injection, pspy, cronjobs, backdoor]
---
...
<figure><center><img src="https://raw.githubusercontent.com/YounesTasra-R4z3rSw0rd/YounesTasra.github.io_Img/main/2023-04-20%2022_43_40-HACKING_MACHINE%20-%20VMware%20Workstation%2017%20Player%20(Non-commercial%20use%20only).png"></center><center><em><figcaption>http://team.thm</figcaption></em></center></figure>
...
<figure><center><img src="https://github.com/YounesTasra-R4z3rSw0rd/YounesTasra.github.io_Img/blob/main/2023-04-20%2022_50_40-HACKING_MACHINE%20-%20VMware%20Workstation%2017%20Player%20(Non-commercial%20use%20only).png?raw=true"></center><center><em><figcaption>/robots.txt</figcaption></em></center></figure>
* ```/scripts```: This directory looks promissing but unfortunately we cannot access it:
<figure><center><img src="https://github.com/YounesTasra-R4z3rSw0rd/YounesTasra.github.io_Img/blob/main/2023-04-20%2022_48_55-HACKING_MACHINE%20-%20VMware%20Workstation%2017%20Player%20(Non-commercial%20use%20only).png?raw=true"></center><center><em><figcaption>/scripts</figcaption></em></center></figure>
...
<figure><center><img src="https://github.com/YounesTasra-R4z3rSw0rd/YounesTasra.github.io_Img/blob/main/2023-04-21%2000_22_21-HACKING_MACHINE%20-%20VMware%20Workstation%2017%20Player%20(Non-commercial%20use%20only).png?raw=true"></center><center><em><figcaption>http://dev.team.thm</figcaption></em></center></figure>
...
<figure><center><img src="https://github.com/YounesTasra-R4z3rSw0rd/YounesTasra.github.io_Img/blob/main/2023-04-21%2000_28_44-HACKING_MACHINE%20-%20VMware%20Workstation%2017%20Player%20(Non-commercial%20use%20only).png?raw=true"></center><center><em><figcaption>http://dev.team.thm/script.php?page=teamshare.php</figcaption></em></center></figure>
...
<figure><center><img src="https://raw.githubusercontent.com/YounesTasra-R4z3rSw0rd/YounesTasra-R4z3rSw0rd.github.io/main/assets/img/thm-team/2023-04-21 18_07_18-HACKING_MACHINE - VMware Workstation 17 Player (Non-commercial use only).png"></center><center><em><figcaption>/etc/passwd</figcaption></em></center></figure>
...
```
<figure><center><img src="https://raw.githubusercontent.com/YounesTasra-R4z3rSw0rd/YounesTasra-R4z3rSw0rd.github.io/main/assets/img/thm-team/2023-04-21 18_26_20-HACKING_MACHINE - VMware Workstation 17 Player (Non-commercial use only).png"></center><center><em><figcaption>php://filter/convert.base64-encode/resource=script.php</figcaption></em></center></figure>
...
To simplify the process, we can use the following Python script to automate the exploitation of this ```LFI``` vulnerability:
...
<figure><center><img src="https://raw.githubusercontent.com/YounesTasra-R4z3rSw0rd/YounesTasra-R4z3rSw0rd.github.io/main/assets/img/thm-team/2023-04-24 00_14_51-HACKING_MACHINE - VMware Workstation 17 Player (Non-commercial use only).png"></center><center><em><figcaption>Burpsuite (Intruder)</figcaption></em></center></figure>
...
#### **🚩 user.txt**:
<figure><center><img src="https://raw.githubusercontent.com/YounesTasra-R4z3rSw0rd/YounesTasra-R4z3rSw0rd.github.io/main/assets/img/thm-team/2023-04-24 00_34_39-HACKING_MACHINE - VMware Workstation 17 Player (Non-commercial use only).png"></center><center><em><figcaption>user flag</figcaption></em></center></figure>

#### 📍 Manual Enumeration:
Dale can run ```/home/gyles/admin_checks``` as ```gyles```:
<figure><center><img src="https://raw.githubusercontent.com/YounesTasra-R4z3rSw0rd/YounesTasra-R4z3rSw0rd.github.io/main/assets/img/thm-team/2023-04-24 12_43_14-HACKING_MACHINE - VMware Workstation 17 Player (Non-commercial use only).png"></center><center><em><figcaption>sudo -l</figcaption></em></center></figure>

Content of ```/home/gyles/admin_checks``` file:
<figure><center><img src="https://raw.githubusercontent.com/YounesTasra-R4z3rSw0rd/YounesTasra-R4z3rSw0rd.github.io/main/assets/img/thm-team/2023-04-24 12_46_21-HACKING_MACHINE - VMware Workstation 17 Player (Non-commercial use only).png"></center><center><em><figcaption>/home/gyles/admin_checks</figcaption></em></center></figure>
...
<figure><center><img src="https://raw.githubusercontent.com/YounesTasra-R4z3rSw0rd/YounesTasra-R4z3rSw0rd.github.io/main/assets/img/thm-team/2023-04-25 14_58_05-HACKING_MACHINE - VMware Workstation 17 Player (Non-commercial use only).png"></center><center><em><figcaption>id</figcaption></em></center></figure>

So far so good, now to get a shell as ```gyles``` we can inject ```/bin/bash```:
<figure><center><img src="https://raw.githubusercontent.com/YounesTasra-R4z3rSw0rd/YounesTasra-R4z3rSw0rd.github.io/main/assets/img/thm-team/2023-04-25 15_03_53-HACKING_MACHINE - VMware Workstation 17 Player (Non-commercial use only).png"></center><center><em><figcaption>/bin/bash</figcaption></em></center></figure>

**Shell stabilization:** ```python3 -c 'import pty;pty.spawn("/bin/bash")'```:
<figure><center><img src="https://raw.githubusercontent.com/YounesTasra-R4z3rSw0rd/YounesTasra-R4z3rSw0rd.github.io/main/assets/img/thm-team/2023-04-25 15_08_29-HACKING_MACHINE - VMware Workstation 17 Player (Non-commercial use only).png"></center><center><em><figcaption>Shell Stabilization</figcaption></em></center></figure>
...
<figure><center><img src="https://raw.githubusercontent.com/YounesTasra-R4z3rSw0rd/YounesTasra-R4z3rSw0rd.github.io/main/assets/img/thm-team/2023-04-25 15_49_24-HACKING_MACHINE - VMware Workstation 17 Player (Non-commercial use only).png"></center><center><em><figcaption>uploading pspy</figcaption></em></center></figure>
...
<figure><center><img src="https://raw.githubusercontent.com/YounesTasra-R4z3rSw0rd/YounesTasra-R4z3rSw0rd.github.io/main/assets/img/thm-team/2023-04-25 15_52_06-HACKING_MACHINE - VMware Workstation 17 Player (Non-commercial use only).png"></center><center><em><figcaption>pspy output</figcaption></em></center></figure>

#### **<strong><font color="DarkKhaki">/opt/admin_stuff/script.sh</font></strong>**
<figure><center><img src="https://raw.githubusercontent.com/YounesTasra-R4z3rSw0rd/YounesTasra-R4z3rSw0rd.github.io/main/assets/img/thm-team/2023-04-25 15_28_47-HACKING_MACHINE - VMware Workstation 17 Player (Non-commercial use only).png"></center><center><em><figcaption>/opt/admin_stuff/script.sh</figcaption></em></center></figure>
...
<figure><center><img src="https://raw.githubusercontent.com/YounesTasra-R4z3rSw0rd/YounesTasra-R4z3rSw0rd.github.io/main/assets/img/thm-team/2023-04-25 15_30_21-HACKING_MACHINE - VMware Workstation 17 Player (Non-commercial use only).png"></center><center><em><figcaption>/usr/local/bin/main_backup.sh</figcaption></em></center></figure>
...
<figure><center><img src="https://raw.githubusercontent.com/YounesTasra-R4z3rSw0rd/YounesTasra-R4z3rSw0rd.github.io/main/assets/img/thm-team/2023-04-25 15_59_09-HACKING_MACHINE - VMware Workstation 17 Player (Non-commercial use only).png"></center><center><em><figcaption>Planting a reverse shell payload</figcaption></em></center></figure>

#### **🚩 root.txt**:
<figure><center><img src="https://raw.githubusercontent.com/YounesTasra-R4z3rSw0rd/YounesTasra-R4z3rSw0rd.github.io/main/assets/img/thm-team/2023-04-25 16_00_42-HACKING_MACHINE - VMware Workstation 17 Player (Non-commercial use only).png"></center><center><em><figcaption>root flag</figcaption></em></center></figure>
