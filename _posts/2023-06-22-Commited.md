---
layout: post
title: TryHackMe | Commited
date: 2023-06-22 12:00:00 -500
categories: [TryHackMe, Easy]
tags: [ctf, Git Repository, .git, Sensitive data exposure, Information disclosure, git-cola, git]
---
...
* As you can see, there are 9 commits in total, each is represented with a folder that contains the following text files:
