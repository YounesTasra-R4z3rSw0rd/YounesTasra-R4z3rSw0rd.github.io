...
tags: [ctf, CyberTalents, Web Exploitation, Code Injection, PHP, eval(), SQL Injection, XSS]
---
...
<center><strong><font color="DarkGray"><a href="https://cybertalents.com/challenges/web/hashable" target="_blank"><er>Hashable</er></a> is a Web Exploitation challenge from CyberTalents that revolves around exploiting a command injection vulnerability with a bypass of a rudimentary input check to obtain the flag.</font></strong></center>
